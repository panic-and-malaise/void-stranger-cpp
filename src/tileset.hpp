...
public:
	void init_tile_definitions(const std::unordered_map<std::string, sf::Texture> &textures) {
		definitions[(size_t)TileType::BOUNDS] = {
			.texture = nullptr,
			.texture_rect = sf::IntRect({0, 0}, {16, 16}),
			.is_collidable = true,
		...
		definitions[(size_t)TileType::WALL_CORNER_TOP_LEFT] = {
			...
			.texture_rect = sf::IntRect({60, 0}, {16, 16}), // 3 (16px (tile size) + 4px (border between tiles))
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_TOP] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({80, 0}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_CORNER_TOP_RIGHT] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({100, 0}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_SIDE_LEFT] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({120, 0}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_SIDE_RIGHT] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({20, 20}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_CORNER_BOTTOM_LEFT] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({40, 20}, {16, 16}), // 3 (16px (tile size) + 4px (border between tiles))
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_BOTTOM] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({60, 20}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_CORNER_BOTTOM_RIGHT] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({80, 20}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::STATUE_ABADDON] = {
			.texture = &textures.at("spr_statue_abaddon_0"),
			.texture_rect = sf::IntRect({0, 0}, {96, 64}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_0] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({0, 40}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_1] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({40, 40}, {16, 16}),
			.is_collidable = true
		};

		definitions[(size_t)TileType::WALL_2] = {
			.texture = &textures.at("spr_tile_bg_1"),
			.texture_rect = sf::IntRect({60, 40}, {16, 16}),
			.is_collidable = true
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_0] = {
			...
			.texture_rect = sf::IntRect({40, 0}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_1] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({60, 0}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_5] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({0, 20}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_7] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({100, 20}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_8] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({120, 20}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_10] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({20, 40}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_13] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({80, 40}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_EDGE_14] = {
			.texture = &textures.at("spr_tile_edges"),
			.texture_rect = sf::IntRect({100, 40}, {16, 16}),
			.is_collidable = true,
			.render_under_decoration = false
		};
		...
		definitions[(size_t)TileType::WALL_7] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({17, 0}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_8] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({34, 0}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_9] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({51, 0}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_10] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({0, 17}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_11] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({17, 17}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_12] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({34, 17}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_13] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({51, 17}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_14] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({0, 34}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_15] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({17, 34}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_16] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({34, 34}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_17] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({51, 34}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_18] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({0, 51}, {16, 16}),
			.is_collidable = true,
		};

		definitions[(size_t)TileType::WALL_19] = {
			.texture = &textures.at("spr_tilemap_br2"),
			.texture_rect = sf::IntRect({17, 51}, {16, 16}),
			.is_collidable = true,
		};
		...
		definitions[(size_t)TileType::CHEST_BIG_CLOSE] = {
			...
			.texture_rect = sf::IntRect({ 0, 0}, {32, 16 }),
			.is_collidable = true,
		};
