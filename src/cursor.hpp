...
public:
	...
	void load_sprites() {
		...
		if (paint_cursor_texture.loadFromFile(util::RESOURCE_DIRECTORY + "sprites/paint_cursor.png")) {
		...
		if (eraser_texture.loadFromFile(util::RESOURCE_DIRECTORY + "sprites/paint_eraser.png")) {
		...
		if (eyedropper_texture.loadFromFile(util::RESOURCE_DIRECTORY + "sprites/paint_eyedropper.png")) {
